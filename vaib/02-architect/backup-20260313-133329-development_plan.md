...
- **Negative Constraints**:
  ...
  - НЕ HTTP-обработка (это в API layer)
- **Map**:
...
- **Internal Logic**:
  *** ALGORITHM DESIGN: change_deal_stage ***
  ...
  STEP 2: Проверить существование сделки (404 если нет)
  STEP 3: Получить текущую стадию (old_stage)
  STEP 4: Проверить допустимость перехода по таблице переходов
  STEP 5: ЕСЛИ переход недопустим → вернуть ошибку с допустимыми стадиями
  ...
  ************************
- **Mental Test**: "Passed: Невалидный переход стадии возвращает 400."
...
- Phase 1 - Models & Database - PLANNED
- Phase 2 - Repositories - PLANNED
